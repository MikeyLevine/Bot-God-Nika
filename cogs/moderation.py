...
class Moderation(commands.Cog, name="moderation"):
  ...
  @app_commands.describe(user="The user that should be kicked.",
  ...
  @checks.not_blacklisted()
  @app_commands.describe(user="The user that should be banned.",
  ...
  @checks.not_blacklisted()
  @commands.has_permissions(manage_messages=True)
  @app_commands.describe(user="The user that should be warned.",
